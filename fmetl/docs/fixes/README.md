...
| [FIX-028](FIX-028-v018-evidence-led-ledger-and-release-audit.md) | 按可验证数据重建期初、验收、BOM、加工、换码、成本、分类和发布检查 | ✅完整重跑 / ✅176 项测试 / ✅14 项硬检查 / ⛔发布检查未通过 | 全部 v0.18 计算、审计和输出 |
...
FIX-028 删除 `purchase_di` 当天验收和跨日单位成本回退，按实际验收、当天成本和完整计算窗口
重建账本；缺成本、缺分类、缺验收、配方不明和缺日清继续阻止发布。
