...
| FIX | 问题 | 状态 | 修改文件 | 依赖 | Commit |
|-----|------|:---:|------|------|--------|
| FIX-001 | compose 纯加工关系计算 | ✅ 已实现 | sku_cost.py, stock.py | — | `277f296` `c2cb613` |
| FIX-002 | EUC 兜底链完善 | ⏳ 待实现 | sku_cost.py | FIX-001 | — |
| FIX-003 | 跨日 init_stock 不一致 | 📋 低优先级 | stock.py | FIX-001/002 | — |
| FIX-004 | BOM 父品转移负毛利 | ⏳ 待实现 | stock.py | FIX-001/002 | — |
| FIX-005 | 金额平衡公式修正 | 📋 低优先级 | stock_roll.py | FIX-002/004 | — |
| FIX-006 | 蛋类 -34.9% 偏差 | 🟡 波及分析 | — (FIX-004 自动修复) | FIX-004 | — |
| FIX-007 | 5/29 FM 巨损 | 🟡 波及分析 | — (FIX-004 自动修复) | FIX-004 | — |
| FIX-008 | 标品库存核销 | 🟡 被取代 | — (FIX-009 修复) | FIX-009 | — |
| FIX-009 | is_counted 系统快照 | ✅ 已实现 | stock.py | — | `6ad7e91` |

**已实现 2 个，待实现 2 个 (FIX-002 + FIX-004)，其余为波及分析或低优先级。**
