...
输入: t_fm_levels_sum (SKU级) + dim_goods + t_fm_cust
输出: t_fm_levels_result_matnr (按 matnr 合并 SKU, 中文列名 + 比率 KPI)
"""
...
TARGET_DUCK_TABLE = "t_fm_levels_result_matnr"


class MatnrResultBuilder:
    def __init__(self, duck: DuckDBStore):
        self._duck = duck
        self._log = get_logger("MatnrResultBuilder")
