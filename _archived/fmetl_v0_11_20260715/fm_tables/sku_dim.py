...
class SkuDimBuilder:
    ...
    def build(self, start: str, end: str) -> None:
        ...
        cond_snack       = (c2 == '休闲零食类')
        cond_daily       = (c2 == '日杂用品类')
        # TODO: master-data v2.3 要求冷冻类通过 SKU 清单映射 (config/frozen_skus.json, 126 SKU)
